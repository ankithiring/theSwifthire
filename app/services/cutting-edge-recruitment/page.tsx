...
export default function CuttingEdgeRecruitmentPage() {
  return (
      ...
      <section className="bg-gradient-to-br from-gray-50 to-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="bg-cyan-600 text-white mb-4">Cutting-Edge Recruitment</Badge>
              <h1 className="text-5xl md:text-6xl font-serif font-black text-gray-900 mb-6">
                Cutting-Edge <span className="text-cyan-600">Recruitment</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8 font-sans leading-relaxed">
                SwiftHire LLC uses advanced sourcing, data-driven screening, and smart hiring strategies to identify top talent quickly. We ensure precise matches that align with both technical skills and company culture.
              </p>
