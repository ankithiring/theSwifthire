          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <Card className="border-0 shadow-xl bg-gradient-to-br from-amber-50 to-white">
              <CardContent className="p-8">
                ...
                <div className="flex items-center">
                  <img
                    src="/images/avatar/nextgen-logo.jpg"
                    alt="NextGen logo"
                    className="w-15 h-15 rounded-full mr-4"
                  />
                  <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                ...
                <div className="flex items-center">
                  <img src="/images/avatar/amtrak-logo.jpg" alt="Client" className="w-12 h-12 rounded-full mr-4" />
                  <div>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              <CardContent className="pt-6">
                ...
                <div className="flex items-center">
                  <img src="/images/avatar/emids-logo.png" alt="Client" className="w-12 h-12 rounded-full mr-4" />
                  <div>
